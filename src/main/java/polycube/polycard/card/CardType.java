...
public enum CardType {
    ...
    private static final Map<String, CardType> BY_ID;
    ...
    static {
        Map<String, CardType> byId = new HashMap<>();
    ...
    CardType(String id, String name, Rarity minRarity) {
        this.id = id;
        this.name = name;
    ...
    public static Optional<CardType> fromId(String id) {
